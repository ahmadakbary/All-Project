...
public class UtilityClass extends Base {
	...
	public static void selectByVisibleText(WebElement element, String text) {
		Select dropByText = new Select(element);
		dropByText.selectByVisibleText(text);

	}	
	 //This method will select value from static Dropdown by index
	
	public static void selectByIndex(WebElement element, int index) {
		Select droplistByIndex = new Select(element);
		droplistByIndex.selectByIndex(index);
	}
 //This method will select value from static dropdown by value 
	...
	// sendKeys using JSExecutor we can use SendKeys with JSExecutor if WebElement has either one of ID, Name,
	// or Class attributes
	...
	public static void dragAndDrop(WebElement sourceElement, WebElement targetElement) {
		...
		obj.dragAndDrop(sourceElement, targetElement);
